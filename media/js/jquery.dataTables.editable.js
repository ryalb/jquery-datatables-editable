    ...
    $.fn.makeEditable = function (options) {
        ...
        var iDisplayStart = 0,
            ...
            */
            ...
            fnRefreshEditable = function (cellClass) {
                        ...
                        if (oSettings.aoColumns[iDTindex].bVisible) {//if DataTables column is visible
                            ...
                            cells.each(function () {
                                if (!$(this).hasClass(properties.sReadOnlyCellClass)) {
                                    $(this).editable(properties.sUpdateURL, oColumnSettings);
                                }
                            });
                        }
            ...
            */
            ...
            fnOnRowDeleteInline = function (e) {
                ...
                var jSelectedRow = ($(this).parents("tr"));
        ...
        return this.each(function () {
            ...
            if (oConfirmRowAddingButton !== null && typeof oConfirmRowAddingButton !== "undefined") {
            ...
            if (oCancelRowAddingButton !== null && typeof oCancelRowAddingButton !== "undefined") {
